...
(function () {
  ...
  var RATE = 0.15;         // descuento promedio estimado (conservador)

  var CATS = [
    { icon: '🍽️', label: 'Restaurantes y cafés',            max: 200000, def: 40000, step: 5000 },
    { icon: '💊', label: 'Salud (dentista, óptica, farmacia)', max: 150000, def: 20000, step: 5000 },
    { icon: '🏋️', label: 'Deporte y gimnasio',               max: 100000, def: 20000, step: 5000 },
    { icon: '🎉', label: 'Familia y entretención',           max: 100000, def: 10000, step: 5000 }
  ];
  ...
  function injectStyle() {
    ...
    var css = ''
      ...
      + '.hsc-verdict{font-size:.95rem;color:var(--text-main,#0F172A);margin:.5rem 0 1.1rem;line-height:1.5;}'
  ...
  function build(mount) {
    ...
    html += '</div><div class="hsc-result">'
      + '<div class="hsc-save">Tu ahorro estimado<strong data-save>$0</strong>al mes</div>'
      + '<div class="hsc-verdict" data-verdict></div>'
      + '<a class="btn btn-accent hsc-cta" href="/hazte-socio/">Empezar a ahorrar</a>'
      + '<p class="hsc-note">Estimación referencial con un descuento promedio de 15% sobre lo que gastas en comercios asociados. Tu ahorro real depende de tu uso. Plan mensual $3.990/mes; con el plan anual pagas $2.990/mes.</p>'
      + '</div></div>';
